      ...
      <div class="col" style="color: whitesmoke">
        ...
        <form action="principal.php">
          <div class="input-group mb-3">
            ...
            <input type="email" class="form-control" placeholder="Correo electronico" aria-label="Username" aria-describedby="basic-addon1" style=" background-color: transparent; color: white" id="email" name="email" />
            ...
            <div class="input-group mb-3" style="margin-top: 10%; margin-left: 1%">
              ...
              <input type="password" class="form-control" placeholder="Contraseña" aria-label="Username" aria-describedby="basic-addon1" style="background-color: transparent; color: white" id="password" name="password" />
            </div>
          </div>
          <button type="submit" class="btn btn-outline-light boton-iniciar-sesion" onclick="enviarFormulario()">
            Iniciar Sesion
          </button>
