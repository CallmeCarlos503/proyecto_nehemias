...
<body>
    <div class="color-navbar">
        <?php include_once('./assets/navbarcliente.php')?>
    </div>
    <section class="presentacion-perfil">
        <div class="texto-perfil" style="color: white;">
            <center>
                <h2>MY PROFILE</h2>
            </center>
            <center>
                <img src="https://img.freepik.com/iconos-gratis/usuario_318-563642.jpg" height="100px" alt=""
                    class="foto-perfil">
            </center>
            <div class="move-perfil">
                <center>
                    placeholder name
                </center>
            </div>
    ...
    <div class="zonas" style="padding-bottom: 5px;">
        <br>
